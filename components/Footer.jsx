...
const Footer = () => {
  return (
    <div className="w-screen h-[400px] bg-gradient-to-r to-[#53067A] from-[#A177B6] px-16 py-[60px]   flex flex-col items-center justify-center gap-4">
      <div className="w-full h-[60%] gap-24  flex justify-between  ">
        <div className="w-[300px] h-full  flex flex-col gap-4  ">
          <Image src={Logo} className=" w-full h-full" />
          <p className="font-raleway text-[14px]  text-white">
      ...
      <div className="w-full h-[40%] flex flex-col  justify-end gap-[2px]">
        ...
        <div className="w-full py-5 flex justify-between">
          ...
          <div className="w-[50%] text-right items-end justify-end  text-white flex gap-10">
            <h1 className="font-poppins text-base font-light cursor-pointer ">
              Privacy Policy
            </h1>
            <h1 className="font-poppins text-base font-light cursor-pointer ">
              Terms & Conditions
